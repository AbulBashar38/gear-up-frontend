...
| `src/app/(public)/_components/gear/price-range-slider.tsx` | Accessible dual-handle native range control whose draft minimum/maximum values submit only through the catalog Apply action |
